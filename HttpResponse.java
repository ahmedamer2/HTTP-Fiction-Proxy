...
public class HttpResponse {
     ...
     * moment set to 700 KB. You can adjust this as needed. */
    final static int MAX_OBJECT_SIZE = 700000;//changed to 600KB to accommodate the objects being loaded. Minimum on my machine was 500KB set higher if images not loading properly
